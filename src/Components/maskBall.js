...
import { tmpTrans, physicsWorld, maskBall } from '../physicsWorld'

const MaskBall = (props) => {
    ...
    useFrame((state, delta) => {
        if(physicsWorld){
                ...
                let ms = maskBall.getMotionState();
                if ( ms ) {
    ...
    return (
      <mesh
        ...
        <meshPhongMaterial color={hovered ? 'hotpink' : 'green'} />
      </mesh>
    )
  }

  export default MaskBall;
